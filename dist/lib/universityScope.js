...
export async function resolveUserUniversityId(userId) {
...
export function qbankModuleUniversityFilter(universityId) {
    if (!universityId) {
...
export async function resolveUniversityFromInput(input) {
    ...
    if (id) {
        ...
        if (uni)
            return { universityId: uni.id, university: uni.nameEn };
    }
...
export async function syncModuleUniversities(moduleId, universityIds) {

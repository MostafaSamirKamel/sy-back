...
import { AiKnowledgeKind, AiKnowledgeRole, Role } from '@prisma/client';
...
const ROLES = new Set(Object.values(AiKnowledgeRole));
const KINDS = new Set(Object.values(AiKnowledgeKind));
...
router.put('/:id', async (req, res) => {
    ...
    const entry = await prisma.aiKnowledgeEntry.update({
        ...
        data: {
            ...
            titleAr: req.body?.titleAr !== undefined ? String(req.body.titleAr).trim() : existing.titleAr,

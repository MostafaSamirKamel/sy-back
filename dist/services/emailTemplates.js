...
const copy = {
    en: {
        ...
        intro: 'Welcome to Synoza. Use the verification code below to confirm your email and activate your student account.',
        ...
        textIntro: 'Welcome to Synoza. Use this verification code to confirm your email and activate your account:',
    ...
    ar: {
        ...
        intro: 'أهلاً بك في Synoza. استخدم كود التحقق أدناه لتأكيد بريدك الإلكتروني وتفعيل حسابك الطلابي.',
...
export function buildOtpEmailHtml(firstName, code, siteUrl, lang = 'en') {
    const t = copy[lang];
    const isAr = lang === 'ar';
...
export function buildOtpEmailText(firstName, code, siteUrl, lang = 'en') {
    const t = copy[lang];
...
export function getOtpEmailSubject(lang = 'en') {
...
export function buildPasswordResetEmailHtml(firstName, resetUrl, lang = 'en') {
...
export function buildPasswordResetEmailText(firstName, resetUrl, lang = 'en') {
    const t = resetCopy[lang];
...
export function getPasswordResetEmailSubject(lang = 'en') {

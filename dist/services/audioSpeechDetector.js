 ...
 */
export async function decodeAudioToPcm16k(buffer, mimeType) {
    ...
    try {
        ...
        await execFileAsync(ffmpeg, ['-y', '-i', inputPath, '-ar', String(SAMPLE_RATE), '-ac', '1', '-f', 'wav', wavPath], { timeout: 15_000 });
 ...
 */
export async function audioContainsSpeech(buffer, mimeType) {

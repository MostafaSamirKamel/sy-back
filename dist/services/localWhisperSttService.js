...
function resolveWhisperLanguage(language, forceArabic) {
    if (forceArabic)
        return 'ar';
...
function resolveLocalWhisperModel() {
...
async function getFfmpegExecutable() {
...
function pickTranscriptText(result) {
...
export function isLocalSttEnabled() {
...
export async function transcribeWithLocalWhisper(buffer, mimeType, language, forceArabic) {
    ...
    try {
        ...
        const run = async (whisperLanguage) => {
